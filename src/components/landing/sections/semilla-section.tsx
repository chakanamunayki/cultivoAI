...
export function SemillaSection({ onOpenChatSemilla }: SemillaSectionProps) {
  ...
  return (
    <div id="semilla" className="bg-background border-b-4 border-black">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          <Reveal>
              ...
              <div className="aspect-[16/9] bg-white relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-secondary to-primary/10">
                  <div className="text-center">
                    <Sprout size={80} className="mx-auto text-primary/40 mb-4" strokeWidth={1.5} />
            ...
            <div className="bg-white border-4 border-black p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
              <h3 className="text-2xl font-black uppercase mb-6 bg-secondary inline-block px-2 border-2 border-black">
            ...
            <div className="mt-8 bg-black text-white p-6 md:p-8 border-4 border-white shadow-[8px_8px_0px_0px_var(--primary)]">
              <p className="font-bold italic text-primary text-lg">
          ...
          <Reveal delay={200}>
            {/* What I can do */}
            <div className="mb-12">
              <h3 className="text-3xl font-black uppercase mb-6 text-foreground">
                Servicios
              </h3>
              <div className="space-y-6">
                <div className="bg-secondary border-4 border-black p-6 hover:-translate-y-1 transition-transform">
            ...
            <div className="grid grid-cols-2 gap-4 mb-12">
              {content.semilla.tiers.map((tier, i) => (
                <div
                  key={i}
                  className="bg-white border-4 border-black p-4 shadow-[4px_4px_0px_0px_black] hover:bg-primary hover:text-primary-foreground transition-colors group"
                >
            ...
            <div className="bg-muted border-4 border-black p-4 md:p-6 relative flex flex-col md:flex-row md:items-center md:gap-6">
              ...
              <button
                ...
                className="shrink-0 bg-black text-white border-4 border-transparent px-6 py-3 font-black uppercase hover:bg-white hover:text-black hover:border-black transition-all flex items-center justify-center gap-2 shadow-[6px_6px_0px_0px_var(--primary)] hover:translate-x-1 hover:translate-y-1 hover:shadow-[3px_3px_0px_0px_var(--primary)]"
              >
