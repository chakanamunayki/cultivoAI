    ...
    <footer className="bg-black text-white border-t-4 border-primary">
      ...
      <Reveal>
        <div className="p-8 md:p-16 text-center border-b-4 border-neutral-800">
          <h2 className="text-3xl md:text-4xl lg:text-7xl font-black uppercase mb-6 md:mb-8 tracking-tight">
            {content.footer.cta.split(".")[0]}?
          </h2>
          <button
            type="button"
            onClick={onContactClick}
            className="inline-flex items-center gap-3 px-8 py-4 bg-primary text-primary-foreground font-black uppercase text-lg border-4 border-black shadow-[8px_8px_0px_0px_rgba(255,255,255,0.3)] hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.3)] hover:-translate-y-1 transition-all"
          >
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <Reveal>
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-primary border-2 border-white rounded-xl flex items-center justify-center text-primary-foreground shadow-[2px_2px_0px_0px_rgba(255,255,255,0.5)] transform -rotate-6">
          ...
          <Reveal>
            <div className="space-y-4">
              <h3 className="font-black uppercase text-lg tracking-tight border-b-2 border-primary pb-2 inline-block">
                ...
                {content.footer.quickLinks.map((link) => (
                  <li key={link.href}>
                    <a
                      ...
                      className="text-neutral-300 hover:text-primary hover:pl-2 transition-all font-bold uppercase text-sm"
                    >
                      {link.label}
                    </a>
                  </li>
