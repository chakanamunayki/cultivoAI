...
export const adminContent: Record<Locale, AdminContent> = {
  ...
  pt: {
    ...
    subtitle: "Gestão de leads e conversas",
    nav: {
      dashboard: "Dashboard",
      leads: "Leads",
    ...
    stats: {
      ...
      thisMonth: "Este mês",
      conversations: "Conversas",
      avgMessages: "Média de mensagens",
    ...
    leadDetails: {
      ...
      qualificationBreakdown: "Detalhamento da Qualificação",
      budget: "Indicou orçamento",
      timeline: "Tem prazo",
      useCase: "Caso de uso claro",
      decisionMaker: "Tomador de decisão",
      sectorFit: "Encaixa no setor",
      conversationHistory: "Histórico de Conversas",
      timelineSection: "Linha do tempo",
      noConversations: "Nenhuma conversa registrada",
      summary: "Resumo",
      intent: "Intenção",
    ...
    exportPage: {
      title: "Exportar Leads",
      description: "Baixe os seus leads em formato CSV ou JSON",
