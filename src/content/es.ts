...
export const es: SiteContent = {
  ...
  about: {
    ...
    rockyDescription:
      "14 anos, futbolista, innovador. Rocky esta aprendiendo a construir soluciones con IA mientras balancea el colegio y el futbol. Lidera el Fondo Semilla, donde construye proyectos pequenos para clientes que estan empezando.",
  },
